...
public class Library extends SimpleJfxApplication {

	public static Library simpleApplication;
	
	public Library(AppState... initialStates) {
		super(initialStates);
	}
	...
	public static void addLight() {
		DirectionalLight directionalLight = new DirectionalLight(new Vector3f(-1, -1, -1).normalizeLocal(), ColorRGBA.White.clone());
		Library.simpleApplication.getRootNode().addLight(directionalLight);
	}
