...
public class TestSimplePhysics  extends SimpleApplication {
	...
	public void simpleInitApp() {   
		...
		Node physicsSphere2 = PhysicsTestHelper.createPhysicsTestNode(assetManager,
				physicsSphere.getControl(RigidBodyControl.class).getCollisionShape(), 1);
		physicsSphere2.getControl(RigidBodyControl.class).setPhysicsLocation(new Vector3f(4, 8, 0));
		rootNode.attachChild(physicsSphere2);
		getPhysicsSpace().add(physicsSphere2);

		// Add a physics box to the world
		Node physicsBox = PhysicsTestHelper.createPhysicsTestNode(assetManager,
		...
		Node physicsCylinder = PhysicsTestHelper.createPhysicsTestNode(assetManager,
		...
		Node node2 = PhysicsTestHelper.createPhysicsTestNode(assetManager,
