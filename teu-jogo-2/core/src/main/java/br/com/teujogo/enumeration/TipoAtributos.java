...
public enum TipoAtributos {
	...
	private TipoAtributos(int valor, String descricao, String label) {
		this.valor = valor;
	...
	public static TipoAtributos getElemento(int valor) {
	...
	public static TipoAtributos getElementoByName(String valor) {
	...
	public static TipoAtributos getElementoByLabel(String valor) {
